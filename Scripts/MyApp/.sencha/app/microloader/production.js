...
(function(global) {
    var emptyFn = function(){},
        ...
        localPath = '/Scripts/build/production/MyApp/',
        documentUri = documentLocation.protocol + '//' + documentLocation.hostname + documentLocation.pathname + documentLocation.search + localPath,
...
//                }
    ...
    function refresh() {
        if (!isRefreshing) {
            isRefreshing = true;
            requestXhr(localPath + manifestFile, function(content) {
    ...
    function blink(currentManifest) {
        ...
        function onReady() {
            ...
            function checkForUpdate() {
                ...
                requestXhr(localPath + manifestFile, function(manifestContent) {
